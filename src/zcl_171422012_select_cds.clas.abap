CLASS zcl_171422012_select_cds DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_171422012_select_cds IMPLEMENTATION.
  ...
  METHOD if_oo_adt_classrun~main.
    ...
    out->write( |Airport from: { airport_from_id } airport to id: { airport_to_id } carrier name: { carrier_name }| ).
